...
{
    [Table("vwCardiologicalCatheterization")]
    public class CardiologicalCatheterizationItem
    {
        [Key]
        ...
        [Display(Name = "DominanceTypeName", ResourceType = typeof(Resources.rsCardiologicalCatheterization))]
        ...
        [Display(Name = "PhysicianName", ResourceType = typeof(Resources.rsCardiologicalCatheterization))]
