...
{
    [Table("vwCardiologicalCPB")]
    public class CardiologicalCPBItem
    {
        [Key]
        ...
        [Display(Name = "SampleTypeName", ResourceType = typeof(Resources.rsCardiologicalCPB))]
        ...
        [Display(Name = "BebTypeName", ResourceType = typeof(Resources.rsCardiologicalCPB))]
