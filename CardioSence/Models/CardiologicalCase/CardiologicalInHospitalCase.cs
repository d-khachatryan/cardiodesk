...
namespace CardioSence.Models
{
    ...
    public class CardiologicalInHospitalCase
    {
        [Key]
        ...
        public virtual ICollection<CardiologicalCaseComplian> CardiologicalCaseComplians { get; set; }
        public virtual ICollection<CardiologicalCaseDisease> CardiologicalCaseDiseases { get; set; }
        public virtual ICollection<CardiologicalCaseDrug> CardiologicalCaseDrugs { get; set; }
        public virtual ICollection<CardiologicalCaseInvasion> CardiologicalCaseInvasions { get; set; }
    }
}