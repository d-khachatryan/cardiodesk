...
{
    [Table("vwCardiologicalExamination")]
    public class CardiologicalExaminationItem
    {
        [Key]
        ...
        [Display(Name = "BloodGroupName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
        public string BloodGroupName { get; set; }

        [Display(Name = "RhFactorName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
        public string RhFactorName { get; set; }

        [Display(Name = "HIVStatusName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
        public string HIVStatusName { get; set; }

        [Display(Name = "HBSStatusName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
        public string HBSStatusName { get; set; }

        [Display(Name = "HCVStatusName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
        public string HCVStatusName { get; set; }

        [Display(Name = "TPHAStatusName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
        public string TPHAStatusName { get; set; }

        [Display(Name = "BRUStatusName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
        public string BRUStatusName { get; set; }

        [Display(Name = "TroponinStatusName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
        public string TroponinStatusName { get; set; }

        [Display(Name = "UrineCylinderStatusName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
        public string UrineCylinderStatusName { get; set; }

        [Display(Name = "UrineMicroorganismStatusName", ResourceType = typeof(Resources.rsCardiologicalExamination))]
